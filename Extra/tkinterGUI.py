...
def uploadImage():
    ...
    imgFile = askopenfile(mode="r", filetypes=f_types)
    print("the size is " ,imgFile)
    ...
    if imgFile is not None:
        ...
        imageLable = tkinter.Label(output,image=img,width=700,height=200) 
        ...
        if ID is not None:
            ...
            img2 = ImageTk.PhotoImage(file=ID)

            imageLable0 = tkinter.Label(input,image=img2,width=700,height=200) 
